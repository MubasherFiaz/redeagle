      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
             <form id="demo-form2" action="{{ url('/login') }}" method="post" data-parsley-validate class="form-horizontal form-label-left">
          {{csrf_field()}} 
              <h1>Login Form</h1>
                   @if(session('message'))
...
@endif 
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Red Eagle </h1>
          ...
          <section class="login_content">
           ...
           <h6>To Create an account please contact the Manager of the company to register your self..</h6>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Call Center!</h1>
                  <p>©2018 All Rights Reserved. Privacy and Terms</p>
                </div>
              </div>
            </form>
